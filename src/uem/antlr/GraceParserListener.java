...
public interface GraceParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link GraceParser#ternResult}.
	 * @param ctx the parse tree
	 */
	void enterTernResult(GraceParser.TernResultContext ctx);
	/**
	 * Exit a parse tree produced by {@link GraceParser#ternResult}.
	 * @param ctx the parse tree
	 */
	void exitTernResult(GraceParser.TernResultContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterSimpleVar(GraceParser.SimpleVarContext ctx);
	/**
	 * Exit a parse tree produced by the {@code simpleVar}
	 * labeled alternative in {@link GraceParser#variable}.
	 * @param ctx the parse tree
	 */
	void exitSimpleVar(GraceParser.SimpleVarContext ctx);
	/**
	 * Enter a parse tree produced by the {@code arrVar}
	 * labeled alternative in {@link GraceParser#variable}.
	 * @param ctx the parse tree
	 */
	void enterArrVar(GraceParser.ArrVarContext ctx);
	/**
	 * Exit a parse tree produced by the {@code arrVar}
	 * labeled alternative in {@link GraceParser#variable}.
	 * @param ctx the parse tree
	 */
	void exitArrVar(GraceParser.ArrVarContext ctx);
	/**
