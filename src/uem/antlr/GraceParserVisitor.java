...
public interface GraceParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link GraceParser#ternResult}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTernResult(GraceParser.TernResultContext ctx);
	/**
	 ...
	 * labeled alternative in {@link GraceParser#variable}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSimpleVar(GraceParser.SimpleVarContext ctx);
	/**
	 * Visit a parse tree produced by the {@code arrVar}
	 * labeled alternative in {@link GraceParser#variable}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitArrVar(GraceParser.ArrVarContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code initLit}
	 * labeled alternative in {@link GraceParser#stringLit}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitInitLit(GraceParser.InitLitContext ctx);
	/**
	 * Visit a parse tree produced by the {@code initArrAloc}
	 * labeled alternative in {@link GraceParser#stringLit}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitInitArrAloc(GraceParser.InitArrAlocContext ctx);
	/**
