...
public abstract class BaseScope implements Scope {
    ...
    protected Map<String, LLVM.LLVMValueRef> symLLVMRef = new LinkedHashMap<>();
    ...
    @Override
    public LLVM.LLVMValueRef getLLVMSymRef(String sym) {
        return this.symLLVMRef.get(sym);
    }

    @Override
    public void setLLVMSymRef(String symName, LLVM.LLVMValueRef symLLVMRef) {
        this.symLLVMRef.put(symName, symLLVMRef);
    }
